            ...
            >
              <div className='authorization-block-input'>
                ...
                {this.state.phone.errorState ? (
                  <span className='authorization-input-error'>{this.state.phone.errorText}</span>
                ) : null}
                ...
                {this.state.checker.errorState ? (
                  <span className='authorization-input-error'>{this.state.checker.errorText}</span>
                ) : null}
              </div>
              ...
              <div className='authorization-block-checkbox'>
                ...
                />
                <label className='authorization-label-checkbox' htmlFor='authorization-checkbox'>
                  אישרתי את&nbsp;
                  <a
