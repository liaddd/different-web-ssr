...
var ResourceFactory = /** @class */ (function () {
    ...
    ResourceFactory.prototype.makeDynamoDBStreamingFunction = function () {
        return new cloudform_1.Lambda.Function({
            ...
            FunctionName: cloudform_1.Fn.Join("-", [
                cloudform_1.Fn.Ref(graphql_transformer_common_1.ResourceConstants.PARAMETERS.ElasticSearchStreamingFunctionName),
    ...
    ResourceFactory.prototype.makeDynamoDBStreamEventSourceMapping = function (typeName) {
        return new cloudform_1.Lambda.EventSourceMapping({
            ...
            .dependsOn([
            graphql_transformer_common_1.ModelResourceIDs.ModelTableResourceID(typeName),
    ...
    ResourceFactory.prototype.makeElasticsearchAccessIAMRole = function () {
        return new iam_1.default.Role({
            RoleName: cloudform_1.Fn.Join("-", [
                cloudform_1.Fn.Ref(graphql_transformer_common_1.ResourceConstants.PARAMETERS.ElasticSearchAccessIAMRoleName),
                cloudform_1.Fn.GetAtt(graphql_transformer_common_1.ResourceConstants.RESOURCES.GraphQLAPILogicalID, 'ApiId')
            ]),
    ...
    ResourceFactory.prototype.makeStreamingLambdaIAMRole = function () {
        return new iam_1.default.Role({
            RoleName: cloudform_1.Fn.Join("-", [
                cloudform_1.Fn.Ref(graphql_transformer_common_1.ResourceConstants.PARAMETERS.ElasticSearchStreamingIAMRoleName),
                cloudform_1.Fn.GetAtt(graphql_transformer_common_1.ResourceConstants.RESOURCES.GraphQLAPILogicalID, 'ApiId')
            ]),
            AssumeRolePolicyDocument: {
                Version: "2012-10-17",
        ...
        return new appSync_1.default.Resolver({
            ...
            RequestMappingTemplate: cloudform_1.Fn.Sub(graphql_mapping_template_1.print(graphql_mapping_template_1.compoundExpression([
                ...
                graphql_mapping_template_1.ElasticSearchMappingTemplate.searchItem({
                    ...
                    size: graphql_mapping_template_1.ifElse(graphql_mapping_template_1.ref('context.args.limit'), graphql_mapping_template_1.ref('context.args.limit'), graphql_mapping_template_1.int(10)),
                    from: graphql_mapping_template_1.ifElse(graphql_mapping_template_1.ref('context.args.nextToken'), graphql_mapping_template_1.ref('context.args.nextToken'), graphql_mapping_template_1.int(0)),
                ...
                'DDBTableName': cloudform_1.Fn.Join('-', [type, cloudform_1.Fn.GetAtt(graphql_transformer_common_1.ResourceConstants.RESOURCES.GraphQLAPILogicalID, 'ApiId')])
            }),
            ...
            .dependsOn([
            graphql_transformer_common_1.ResourceConstants.RESOURCES.GraphQLSchemaLogicalID,
