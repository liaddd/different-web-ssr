          ...
          <div className='modal-content'>
            ...
            <div className='modal-inner-content'>
              <div className='modal-info-block'>
                ...
                <div className='modal-info-contacts'>לכל פנייה ושאלה אנו כאן לשירותך,</div>
                <div className='modal-info-column'>
                  ...
                  <div className='modal-info-column-item'>
                    ...
                    <a href='tel:073-7598885'>073-7598885</a>
                  </div>
                </div>
                ...
                <Link href={'/personal-info/step1'}>
                  <a className='btn btn-blue btn-small'>
                    <div className='btn-block'>+ הוסף בטחון בשכירות לנכס נוסף</div>
                  </a>
                </Link>
